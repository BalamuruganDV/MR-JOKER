...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('ՏႮᏢᏢϴᎡͲ', url=f'https://t.me/{SUPPORT_CHAT}')
            ]]
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                buttons = [[
                InlineKeyboardButton('👉 ⚠️ ᏢᎡᎬՏՏ ᎷᎬ...🥰 👈', url="https://t.me/mrJOKERCHANNEL")
            ]]
                if (temp.MELCOW).get('ᏔᎬᏞᏟϴᎷᎬ') is not None:
                    try:
                        await (temp.MELCOW['welcome']).delete()
                    except:
                        pass
                temp.MELCOW['ᏔᎬᏞᏟϴᎷᎬ'] = await message.reply_text(
